...
<head>
    ...
    <title>SmartSocket | Live Feed</title>
    ...
    <div class="main-content">
        ...
        <div class="container-list">
            <div class="list-wrapper">
                <div class="list-title">Live Feed from Devices</div>
                <table>
                    <thead>
                        <tr>
                            <th>Appliance Name</th>
                            <th>Appliance Serial Code</th>
                            <th>Live Voltage</th>
                            <th>Live Wattage</th>
                            <th>Live Current</th>
                            <th>Condition</th>
                    ...
                    <tbody>
                        <?php foreach ($ratedValues as $appliance): ?>
                            ...
                            if ($live) {
                                ...
                                if ($live['voltageReceived'] < $appliance['minVoltage'] || $live['voltageReceived'] > $appliance['minVoltage']) {
                                    $condition = "Needs Checking";
                                }

                                if ($live['powerReceived'] < $appliance['minWatts'] || $live['powerReceived'] > $appliance['minWatts']) {
                                    $condition = "Needs Maintenance";
                                }

                                if ($live['currentReceived'] < $appliance['minCurrent'] || $live['currentReceived'] > $appliance['minCurrent']) {
                                    $condition = "Needs Maintenance";
                                }
                            } else {
                ...
                <script>
                    ...
                    setInterval(fetchComparisonData, 2000);
                    fetchComparisonData();
                </script>
            </div>
        </div>
