...
<head>
    ...
    <title>SmartSocket | View Appliances</title>
    ...
    <div class="main-content">
        ...
        <div class="container-list">
            <div class="list-wrapper">
                <p class="list-title">Appliances List</p>
                <table>
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Adaptor Serial Code</th>
                            <th>Voltage</th>
                            <th>Wattage</th>
                            <th>Current</th>
                            <th>Actions</th>
                    ...
                    <tbody>
                        <?php foreach ($appliances as $appliance): ?>
                            <tr>
                                ...
                                <td>
                                    <form class="actions" action="../delete_appliance.php" method="POST">
                                        ...
                                        <a href="../edit_appliance.php?appliance_id=<?php echo htmlspecialchars($appliance['appliance_id']); ?>" style="display:inline;" style="display:inline;">
