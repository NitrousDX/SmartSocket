...
try {
    $stmt = $pdo->query("SELECT nameApp, minVoltage, maxVoltage, minWatts, maxWatts, minCurrent, maxCurrent, imagePath, serialNumber FROM appliances");
...
<head>
    ...
    <title>SmartSocket | Rated Values</title>
    ...
    <div class="main-content">
        <div class="main-content-header">
            <div class="main-content-title">
                <p>Rated & Measured Values</p>
            </div>
        </div>

        <div class="container-list">
            <div class="list-wrapper">
                <p class="list-title">Rated Values</p>
                <table>
                    <thead>
                        <tr>
                            <th>Name</th>
